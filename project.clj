(defproject open-company-slack-router "0.1.0-SNAPSHOT"
  ...
  :dependencies [
    ...
    ;; ************************************************************************
    [open-company/lib "0.17.33-alpha4" :exclusions [org.jsoup/jsoup riddley commons-codec clj-http org.apache.httpcomponents/httpclient org.clojure/data.json org.clojure/tools.logging]]
    ;; ************************************************************************
